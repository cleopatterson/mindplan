...
export const assetTypeConfig: Record<string, { label: string; icon: LucideIcon; color: string; gradient: string; iconColor: string; pillColor: string }> = {
  ...
  pension: { label: 'Pension', icon: Landmark, color: 'bg-amber-500/15 text-amber-400', gradient: 'bg-gradient-to-br from-amber-500/20 via-amber-600/10 to-amber-900/20', iconColor: 'text-amber-400', pillColor: 'amber' },
