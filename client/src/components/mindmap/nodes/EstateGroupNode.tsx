...
export const EstateGroupNode = memo(function EstateGroupNode({ data }: { data: NodeData }) {
  return (
    <div
      className={`
        cursor-pointer flex items-center gap-2.5 px-4 py-2.5 rounded-xl bg-indigo-500/90 backdrop-blur text-white w-[200px]
    ...
    >
      ...
      <div className="flex items-center justify-center w-8 h-8 rounded-lg bg-indigo-400/30 shrink-0">
        <ScrollText className="w-4.5 h-4.5 text-indigo-100/70" />
      </div>
